...
export class AppContext {
  ...
  static async fromConfig(
    ...
    const appViewAgent = cfg.codestashAppView
      ? new AtpAgent({ service: cfg.codestashAppView.url })
      : undefined;
    ...
    const localViewer = LocalViewer.creator({
      ...
      appviewDid: cfg.codestashAppView?.did,
      appviewCdnUrlPattern: cfg.codestashAppView?.cdnUrlPattern,
    });
  ...
  async appviewAuthHeaders(did: string) {
    assert(this.cfg.codestashAppView);
    return this.serviceAuthHeaders(did, this.cfg.codestashAppView.did);
  }
