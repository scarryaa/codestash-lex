...
/**
 * @generated from message csync.MuteOperation
 */
export class MuteOperation extends Message<MuteOperation> {
  ...
  /**
   * @generated from field: csync.MuteOperation.Type type = 2;
   */
  ...
  static readonly typeName = "csync.MuteOperation";
...
/**
 * @generated from enum csync.MuteOperation.Type
 */
...
proto3.util.setEnumType(MuteOperation_Type, "csync.MuteOperation.Type", [
...
/**
 * @generated from message csync.AddMuteOperationRequest
 */
export class AddMuteOperationRequest extends Message<AddMuteOperationRequest> {
  /**
   * @generated from field: csync.MuteOperation.Type type = 1;
   */
  type = MuteOperation_Type.UNSPECIFIED;
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "csync.AddMuteOperationRequest";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message csync.AddMuteOperationResponse
 */
export class AddMuteOperationResponse extends Message<AddMuteOperationResponse> {
  /**
   * @generated from field: csync.MuteOperation operation = 1;
   */
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "csync.AddMuteOperationResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message csync.ScanMuteOperationsRequest
 */
export class ScanMuteOperationsRequest extends Message<ScanMuteOperationsRequest> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "csync.ScanMuteOperationsRequest";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message csync.ScanMuteOperationsResponse
 */
export class ScanMuteOperationsResponse extends Message<ScanMuteOperationsResponse> {
  /**
   * @generated from field: repeated csync.MuteOperation operations = 1;
   */
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "csync.ScanMuteOperationsResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
 ...
 * Ping
 *
 * @generated from message csync.PingRequest
 */
export class PingRequest extends Message<PingRequest> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "csync.PingRequest";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
  ]);
...
/**
 * @generated from message csync.PingResponse
 */
export class PingResponse extends Message<PingResponse> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "csync.PingResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
  ]);
